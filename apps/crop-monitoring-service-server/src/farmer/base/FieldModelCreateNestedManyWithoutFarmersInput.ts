...
@InputType()
class FieldModelCreateNestedManyWithoutFarmersInput {
...
export { FieldModelCreateNestedManyWithoutFarmersInput as FieldModelCreateNestedManyWithoutFarmersInput };
